...
- [`Rnimix`](https://madsyair.github.io/Rnimix/reference/Rnimix-package.md)
  [`Rnimix-package`](https://madsyair.github.io/Rnimix/reference/Rnimix-package.md)
  : Rnimix: Bayesian Mixture Clustering and Regression with NIMBLE
...
- [`DPMEngine()`](https://madsyair.github.io/Rnimix/reference/DPMEngine.md)
  : Construct a DPM engine configuration
- [`FixedKEngine()`](https://madsyair.github.io/Rnimix/reference/FixedKEngine.md)
  : Construct a fixed-K finite-mixture engine configuration
- [`DPMEngine-class`](https://madsyair.github.io/Rnimix/reference/DPMEngine-class.md)
  : Dirichlet Process Mixture engine (native NIMBLE dCRP)
- [`FixedKEngine-class`](https://madsyair.github.io/Rnimix/reference/FixedKEngine-class.md)
  : Finite-mixture engine with fixed, known K
- [`EngineConfig-class`](https://madsyair.github.io/Rnimix/reference/EngineConfig-class.md)
  : Virtual base class for mixture sampling engines
- [`HMMEngine()`](https://madsyair.github.io/Rnimix/reference/HMMEngine.md)
...
- [`getDistribution()`](https://madsyair.github.io/Rnimix/reference/getDistribution.md)
  : Retrieve a registered distribution by name
- [`listDistributions()`](https://madsyair.github.io/Rnimix/reference/listDistributions.md)
  : List registered distribution names

## Clustering component specs

- [`NormalUvSpec()`](https://madsyair.github.io/Rnimix/reference/NormalUvSpec.md)
  : Construct a univariate Gaussian component spec
- [`NormalMvSpec()`](https://madsyair.github.io/Rnimix/reference/NormalMvSpec.md)
...
- [`PoissonSpec()`](https://madsyair.github.io/Rnimix/reference/PoissonSpec.md)
  : Construct a Poisson component spec
- [`BinomialSpec()`](https://madsyair.github.io/Rnimix/reference/BinomialSpec.md)
  : Construct a Binomial component spec

## Regression component specs

- [`NormalRegSpec()`](https://madsyair.github.io/Rnimix/reference/NormalRegSpec.md)
  : Construct a Normal-linear regression component spec
- [`StudentTRegSpec()`](https://madsyair.github.io/Rnimix/reference/StudentTRegSpec.md)
  : Construct a Student-t regression component spec
- [`NormalGammaRegSpec()`](https://madsyair.github.io/Rnimix/reference/NormalGammaRegSpec.md)
  : Construct a Normal-Gamma regression component spec
- [`PoissonRegSpec()`](https://madsyair.github.io/Rnimix/reference/PoissonRegSpec.md)
  : Construct a Poisson regression component spec
- [`BinomialRegSpec()`](https://madsyair.github.io/Rnimix/reference/BinomialRegSpec.md)
  : Construct a Binomial regression component spec
- [`NormalMvRegSpec()`](https://madsyair.github.io/Rnimix/reference/NormalMvRegSpec.md)
  : Construct a multivariate-response Normal regression spec
- [`StudentTMvRegSpec()`](https://madsyair.github.io/Rnimix/reference/StudentTMvRegSpec.md)
  : Construct a multivariate-response Student-t regression spec
- [`NormalGammaMvRegSpec()`](https://madsyair.github.io/Rnimix/reference/NormalGammaMvRegSpec.md)
...
- [`MSNBurrRegSpec()`](https://madsyair.github.io/Rnimix/reference/MSNBurrRegSpec-class.md)
  : MSNBurr regression specification
- [`MSNBurr2aRegSpec()`](https://madsyair.github.io/Rnimix/reference/MSNBurr2aRegSpec-class.md)
  : MSNBurr-IIa regression specification
- [`GMSNBurrRegSpec()`](https://madsyair.github.io/Rnimix/reference/GMSNBurrRegSpec-class.md)
  : GMSNBurr regression specification
- [`FSSNRegSpec()`](https://madsyair.github.io/Rnimix/reference/FSSNRegSpec-class.md)
  : FSSN regression specification
- [`FSSTRegSpec()`](https://madsyair.github.io/Rnimix/reference/FSSTRegSpec-class.md)
  : FSST regression specification
- [`SEPRegSpec()`](https://madsyair.github.io/Rnimix/reference/SEPRegSpec-class.md)
  : SEP regression specification
- [`LEPRegSpec()`](https://madsyair.github.io/Rnimix/reference/LEPRegSpec-class.md)
  : LEP regression specification
- [`FOSSEPRegSpec()`](https://madsyair.github.io/Rnimix/reference/FOSSEPRegSpec-class.md)
  : FOSSEP regression specification
- [`JFSTRegSpec()`](https://madsyair.github.io/Rnimix/reference/JFSTRegSpec-class.md)
...
- [`buildModelCode()`](https://madsyair.github.io/Rnimix/reference/buildModelCode.md)
...
- [`validateParams()`](https://madsyair.github.io/Rnimix/reference/validateParams.md)
  : Validate component parameters or a prior specification
- [`customizeSamplers()`](https://madsyair.github.io/Rnimix/reference/customizeSamplers.md)
...
- [`plotClusterMap()`](https://madsyair.github.io/Rnimix/reference/plotClusterMap.md)
...
- [`isRegressionSpec()`](https://madsyair.github.io/Rnimix/reference/isRegressionSpec.md)
  : Is this a regression component spec?
- [`linkInv()`](https://madsyair.github.io/Rnimix/reference/linkInv.md)
...
- [`DistributionSpec-class`](https://madsyair.github.io/Rnimix/reference/DistributionSpec-class.md)
  : Virtual base class for mixture component distributions
- [`MixtureModel-class`](https://madsyair.github.io/Rnimix/reference/MixtureModel-class.md)
  : Virtual base class for mixture models
- [`ClusterModel-class`](https://madsyair.github.io/Rnimix/reference/ClusterModel-class.md)
  : Mixture clustering model (for nimixClust)
- [`RegressionMixModel-class`](https://madsyair.github.io/Rnimix/reference/RegressionMixModel-class.md)
  : Mixture-of-regressions model (for nimixReg)
- [`show(`*`<FitResult>`*`)`](https://madsyair.github.io/Rnimix/reference/FitResult-class.md)
  [`summary(`*`<FitResult>`*`)`](https://madsyair.github.io/Rnimix/reference/FitResult-class.md)
  [`plot(`*`<FitResult>`*`,`*`<missing>`*`)`](https://madsyair.github.io/Rnimix/reference/FitResult-class.md)
  [`predict(`*`<FitResult>`*`)`](https://madsyair.github.io/Rnimix/reference/FitResult-class.md)
  : Fitted Rnimix mixture result
- [`NormalUvSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalUvSpec-class.md)
  : Univariate Gaussian component specification
- [`NormalMvSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalMvSpec-class.md)
  : Multivariate Gaussian component specification
- [`StudentTUvSpec-class`](https://madsyair.github.io/Rnimix/reference/StudentTUvSpec-class.md)
  : Univariate Student-t component specification
- [`StudentTMvSpec-class`](https://madsyair.github.io/Rnimix/reference/StudentTMvSpec-class.md)
  : Multivariate Student-t component specification (direct density)
- [`NormalGammaUvSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalGammaUvSpec-class.md)
  : Univariate Normal-Gamma (scale-mixture Student-t) component
  specification
- [`NormalGammaMvSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalGammaMvSpec-class.md)
  : Multivariate Normal-Gamma (scale-mixture multivariate-t) component
- [`PoissonSpec-class`](https://madsyair.github.io/Rnimix/reference/PoissonSpec-class.md)
  : Poisson count component specification
- [`BinomialSpec-class`](https://madsyair.github.io/Rnimix/reference/BinomialSpec-class.md)
  : Binomial count component specification
- [`NormalRegSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalRegSpec-class.md)
  : Normal-linear regression component specification
- [`StudentTRegSpec-class`](https://madsyair.github.io/Rnimix/reference/StudentTRegSpec-class.md)
  : Student-t mixture regression component (direct t density)
- [`NormalGammaRegSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalGammaRegSpec-class.md)
  : Normal-Gamma mixture regression component (conjugate scale-mixture)
- [`PoissonRegSpec-class`](https://madsyair.github.io/Rnimix/reference/PoissonRegSpec-class.md)
  : Poisson GLM regression component (log link)
- [`BinomialRegSpec-class`](https://madsyair.github.io/Rnimix/reference/BinomialRegSpec-class.md)
  : Binomial GLM regression component (logit link)
- [`NormalMvRegSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalMvRegSpec-class.md)
  : Multivariate-response Normal mixture regression
- [`StudentTMvRegSpec-class`](https://madsyair.github.io/Rnimix/reference/StudentTMvRegSpec-class.md)
  : Multivariate-response Student-t mixture regression (direct density)
- [`NormalGammaMvRegSpec-class`](https://madsyair.github.io/Rnimix/reference/NormalGammaMvRegSpec-class.md)
...
- [`MSNBurr2aUvSpec()`](https://madsyair.github.io/Rnimix/reference/MSNBurr2aUvSpec-class.md)
  : MSNBurr-IIa mixture components (neo-normal, right-skew capable)
- [`GMSNBurrUvSpec()`](https://madsyair.github.io/Rnimix/reference/GMSNBurrUvSpec-class.md)
...
- [`LEPUvSpec()`](https://madsyair.github.io/Rnimix/reference/LEPUvSpec-class.md)
  : LEP mixture components (exponential power, alternative
  parameterisation)
- [`FSSNUvSpec()`](https://madsyair.github.io/Rnimix/reference/FSSNUvSpec-class.md)
  : FSSN mixture components (Fernandez-Steel skew Normal)
- [`FOSSEPUvSpec()`](https://madsyair.github.io/Rnimix/reference/FOSSEPUvSpec-class.md)
  : FOSSEP mixture components (Fernandez-Steel skew exponential power)
- [`FSSTUvSpec()`](https://madsyair.github.io/Rnimix/reference/FSSTUvSpec-class.md)
  : FSST mixture components (Fernandez-Steel skew Student-t)
- [`JFSTUvSpec()`](https://madsyair.github.io/Rnimix/reference/JFSTUvSpec-class.md)
  : JFST mixture components (Jones-Faddy skew-t)
- [`SkewNormalMvSpec()`](https://madsyair.github.io/Rnimix/reference/SkewNormalMvSpec-class.md)
  : Skew multivariate Normal mixture components (Ferreira-Steel)
- [`SkewIStudentMvSpec()`](https://madsyair.github.io/Rnimix/reference/SkewIStudentMvSpec-class.md)
  : Skew multivariate independent-Student mixture components
  (Ferreira-Steel)
- [`SkewNormalMvOSpec()`](https://madsyair.github.io/Rnimix/reference/SkewNormalMvOSpec-class.md)
  : Skew multivariate Normal components with estimated orthogonal factor
- [`SkewIStudentMvOSpec()`](https://madsyair.github.io/Rnimix/reference/SkewIStudentMvOSpec-class.md)
  : Skew mv independent-Student components with estimated orthogonal
  factor
- [`SkewNormalMvOGenSpec()`](https://madsyair.github.io/Rnimix/reference/SkewNormalMvOGenSpec-class.md)
  : Skew multivariate Normal components with estimated O, general
  dimension
- [`SkewIStudentMvOGenSpec()`](https://madsyair.github.io/Rnimix/reference/SkewIStudentMvOGenSpec-class.md)
...
- [`dmsnburr()`](https://madsyair.github.io/Rnimix/reference/msnburr-distribution.md)
  [`pmsnburr()`](https://madsyair.github.io/Rnimix/reference/msnburr-distribution.md)
  [`qmsnburr()`](https://madsyair.github.io/Rnimix/reference/msnburr-distribution.md)
  [`rmsnburr()`](https://madsyair.github.io/Rnimix/reference/msnburr-distribution.md)
  : MSNBurr Distribution
- [`dmsnburr2a()`](https://madsyair.github.io/Rnimix/reference/msnburr2a-distribution.md)
  [`pmsnburr2a()`](https://madsyair.github.io/Rnimix/reference/msnburr2a-distribution.md)
  [`qmsnburr2a()`](https://madsyair.github.io/Rnimix/reference/msnburr2a-distribution.md)
  [`rmsnburr2a()`](https://madsyair.github.io/Rnimix/reference/msnburr2a-distribution.md)
  : MSNBurr-IIa Distribution
- [`dgmsnburr()`](https://madsyair.github.io/Rnimix/reference/gmsnburr-distribution.md)
  [`pgmsnburr()`](https://madsyair.github.io/Rnimix/reference/gmsnburr-distribution.md)
  [`qgmsnburr()`](https://madsyair.github.io/Rnimix/reference/gmsnburr-distribution.md)
  [`rgmsnburr()`](https://madsyair.github.io/Rnimix/reference/gmsnburr-distribution.md)
  : GMSNBurr Distribution
- [`dsep()`](https://madsyair.github.io/Rnimix/reference/sep-distribution.md)
  [`psep()`](https://madsyair.github.io/Rnimix/reference/sep-distribution.md)
  [`qsep()`](https://madsyair.github.io/Rnimix/reference/sep-distribution.md)
  [`rsep()`](https://madsyair.github.io/Rnimix/reference/sep-distribution.md)
  : Subbotin Exponential Power (SEP) Distribution
- [`dlep()`](https://madsyair.github.io/Rnimix/reference/lep-distribution.md)
  [`plep()`](https://madsyair.github.io/Rnimix/reference/lep-distribution.md)
  [`qlep()`](https://madsyair.github.io/Rnimix/reference/lep-distribution.md)
  [`rlep()`](https://madsyair.github.io/Rnimix/reference/lep-distribution.md)
  : Lunetta Exponential Power Distribution
- [`dfssn()`](https://madsyair.github.io/Rnimix/reference/fssn-distribution.md)
  [`pfssn()`](https://madsyair.github.io/Rnimix/reference/fssn-distribution.md)
  [`qfssn()`](https://madsyair.github.io/Rnimix/reference/fssn-distribution.md)
  [`rfssn()`](https://madsyair.github.io/Rnimix/reference/fssn-distribution.md)
  : Fernandez-Steel Skew Normal Distribution
- [`dfossep()`](https://madsyair.github.io/Rnimix/reference/fossep-distribution.md)
  [`pfossep()`](https://madsyair.github.io/Rnimix/reference/fossep-distribution.md)
  [`qfossep()`](https://madsyair.github.io/Rnimix/reference/fossep-distribution.md)
  [`rfossep()`](https://madsyair.github.io/Rnimix/reference/fossep-distribution.md)
  : Fernandez-Osiewalski-Steel Skew Exponential Power Distribution
- [`dfsst()`](https://madsyair.github.io/Rnimix/reference/fsst-distribution.md)
  [`pfsst()`](https://madsyair.github.io/Rnimix/reference/fsst-distribution.md)
  [`qfsst()`](https://madsyair.github.io/Rnimix/reference/fsst-distribution.md)
  [`rfsst()`](https://madsyair.github.io/Rnimix/reference/fsst-distribution.md)
  : Fernandez-Steel Skew t Distribution
- [`djfst()`](https://madsyair.github.io/Rnimix/reference/jfst-distribution.md)
  [`pjfst()`](https://madsyair.github.io/Rnimix/reference/jfst-distribution.md)
  [`qjfst()`](https://madsyair.github.io/Rnimix/reference/jfst-distribution.md)
  [`rjfst()`](https://madsyair.github.io/Rnimix/reference/jfst-distribution.md)
...
- [`dskewmvit()`](https://madsyair.github.io/Rnimix/reference/skewistudent-mv-distribution.md)
  [`rskewmvit()`](https://madsyair.github.io/Rnimix/reference/skewistudent-mv-distribution.md)
  : Ferreira-Steel skew multivariate independent-Student
- [`dskewmvno()`](https://madsyair.github.io/Rnimix/reference/skewnormal-mv-o-distribution.md)
  [`rskewmvno()`](https://madsyair.github.io/Rnimix/reference/skewnormal-mv-o-distribution.md)
  : Ferreira-Steel skew multivariate Normal with estimated orthogonal
  factor
- [`dskewmvito()`](https://madsyair.github.io/Rnimix/reference/skewistudent-mv-o-distribution.md)
  [`rskewmvito()`](https://madsyair.github.io/Rnimix/reference/skewistudent-mv-o-distribution.md)
...
- [`show(`*`<SpatialWeightSpec>`*`)`](https://madsyair.github.io/Rnimix/reference/SpatialWeightSpec-class.md)
  : Spatial neighbourhood structure for spatially constrained mixtures

## Model containers

- [`ClusterModel()`](https://madsyair.github.io/Rnimix/reference/ClusterModel.md)
  : Construct a ClusterModel
- [`RegressionMixModel()`](https://madsyair.github.io/Rnimix/reference/RegressionMixModel.md)
...
- [`priorPredictive()`](https://madsyair.github.io/Rnimix/reference/priorPredictive.md)
...
- [`componentDensity()`](https://madsyair.github.io/Rnimix/reference/componentDensity.md)
...
- [`componentInits()`](https://madsyair.github.io/Rnimix/reference/componentInits.md)
...
- [`buildDataList()`](https://madsyair.github.io/Rnimix/reference/buildDataList.md)
  :

  Shape the observed data into the NIMBLE `data` list

- [`extractParamTraces()`](https://madsyair.github.io/Rnimix/reference/extractParamTraces.md)
  : Parse raw cluster-parameter traces from the MCMC sample matrix

- [`relabelComponents()`](https://madsyair.github.io/Rnimix/reference/relabelComponents.md)
...
- [`dmvt_nimix()`](https://madsyair.github.io/Rnimix/reference/dmvt_nimix.md)
  [`rmvt_nimix()`](https://madsyair.github.io/Rnimix/reference/dmvt_nimix.md)
...
- [`predict(`*`<nimixEnsemble>`*`)`](https://madsyair.github.io/Rnimix/reference/predict-nimixEnsemble.md)
